...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/AdijayaTunneling/ip/main/ip"
rm -f /usr/bin/user
...
wget raw.githubusercontent.com/Garut-SisiLaut/jawabarat/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
print_success "UDP-CUSTOM BY ADIJAYA"
clear
...
print_success "NOOBZVPNS BY ADIJAYA"
}
